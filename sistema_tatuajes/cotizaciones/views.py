...
def solicitar_cotizacion(request, tatuador_id=None):
    ...
    if tatuador_id:
        tatuador_obj     = get_object_or_404(User, pk=tatuador_id,
                               perfil__rol__in=['tatuador', 'propietario'],
                               perfil__estudio=request.studio)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, '✅ ¡Solicitud enviada correctamente! Recibirás una respuesta por correo pronto.')

...
SECRET_KEY = 'django-insecure-#4ubw&#9ng$l$m7t)+!k+0zjp52)b65t*&&vs7pi57^!t*47iq'
...
# Configuración para imágenes subidas por usuarios
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Configuración de correos para entorno de desarrollo (Local)
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
DEFAULT_FROM_EMAIL = 'estudio@tatuajes.com'
